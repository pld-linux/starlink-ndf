...
służący do przechowywania danych w postaci n-wymiarowych tablic liczb.
Jest zwykle używany do przechowywania widm, obrazów i podobnych
zbiorów danych o większej liczbie wymiarów. Format NDF jest oparty na
...
opisu danych, ale może być także nieskończenie rozszerzany do obsługi
dodatkowych zdefiniowanych przez użytkownika informacji dowolnego
typu.
...
Pliki nagłówkowe bibliotek NDF.
